...
export const addInvoice = (data) =>
  post(url.ADD_INVOICE, data)

//delete invoice 
export const deleteInvoice = (data) => del(url.DELETE_INVOICE, { headers: { data } })

//update invoice
export const updateInvoice = (data) => put(url.UPDATE_INVOICE, data)
